...
const Navbar = () => {
  ...
  const linkClass =
    "text-gray-800 font-bold hover:text-blue-600 shadow-lg p-2 text-center transition-colors duration-200";
  ...
  return (
    <nav className="bg-white fixed top-0 left-0 w-full  shadow-md p-4 flex items-center justify-between z-50">
      ...
      {mobileMenuOpen && (
        <div className="absolute top-16 right-4 bg-gradient-to-l from-pink-300 via-pink-200 to-pink-100 shadow-lg border-e-black rounded-md p-4 w-60 flex gap-3 flex-col space-y-3 z-50 md:hidden">
         <a href="#home" className={linkClass} onClick={closeMenu}>Home</a>
